            ...
            <h1>Salads</h1>
                ...
                <div className='grid-menu'>
                    ...
                    <div className='grid-desc'>
                        ...
                        {/* DESCRIPTION */}
                        <p>
                            Spring mix salad, corn and salad
                            dressing
                            <br />
                            <br />
                            <br />
                    ...
                    <div className='grid-desc'>
                        ...
                        {/* DESCRIPTION */}
                        <p>
                            Spring mix salad, seaweed, crispy
                    ...
                    <div className='grid-desc'>
                        ...
                        <p>
                        {/* DESCRIPTION */}
                            Lightly seasoned mixed seaweed
                            salad with deep fried mushrooms
                            <br />
                            <br />
                            <br />
                        </p>
                    ...
                    <div className='grid-desc'>
                        ...
                        {/* DESCRIPTION */}
                        <p>
                            Cold tofu topped with white pepper,
                            miso mayonnaise, onion chips,
                            smoked bonito flakes, green onion
